...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)(['saveToken'])), {}, {
    validate: function validate() {
      var _this = this;

      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var user, response, credentials;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/login', user);
              ...
              case 10:
                ...
                console.log('Este es el error: ' + _context.t0.response.data.message);
    ...
    _c("div", { staticClass: "register-box" }, [
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "card-body register-card-body" }, [
          _c("p", { staticClass: "login-box-msg" }, [_vm._v("Soy Futbolero")]),
          _vm._v(" "),
          _c("form", { ref: "form", attrs: { method: "post" } }, [
            _c("div", { staticClass: "input-group" }, [
              _c("input", {
                ...
                attrs: { type: "email", placeholder: "Usuario", required: "" },
            ...
            _c("p", {
              ...
              domProps: { innerHTML: _vm._s(_vm.errors.usuario) },
            }),
            _vm._v(" "),
            _c("div", { staticClass: "input-group" }, [
              _c("input", {
